...
extension ExploreViewController: ARSKViewDelegate {
    ...
    func view(_ view: ARSKView,
        ...
        if let url = URL(string: "hhttps://firebasestorage.googleapis.com/v0/b/MemMapinfo.appspot.com/o/theImage.png?alt=media&token=6f01e52c-d00f-405d-aeb3-c2983461d6c8") {
